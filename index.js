...
let temperature = tempCelsius;
const farenheit = "F"

function temperatureInF(temperature,farenheit) {
  
  return Math.round(temperatureCtoF(tempCelsius)) + farenheit;
}
...
fruit = ['orange', 'apple', 'banana', 'apples', 'apple', 'mango'];
...
let exportInventory = [{ id: 1, car_make: "Lincoln", car_model: "Navigator", car_year: 2009 },
{ id: 2, car_make: "Mazda", car_model: "Miata MX-5", car_year: 2001 },
{ id: 3, car_make: "Land Rover", car_model: "Defender Ice Edition", car_year: 2010 },
{ id: 4, car_make: "Honda", car_model: "Accord", car_year: 1983 },
{ id: 5, car_make: "Mitsubishi", car_model: "Galant", car_year: 1990 },
...
function getLastCarInfo(inventory) {
  return "This is a " + exportInventory[exportInventory.length -1].car_make + ' ' + exportInventory[exportInventory.length -1].car_model;
}
...
function getModelYears(inventory) {
  for (i = 0; i < exportInventory.length; i++){
  return exportInventory.car_year;
}
}
